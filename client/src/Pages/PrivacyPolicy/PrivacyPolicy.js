    ...
    <Container>
      <div id='design'>
        ...
        <p>
          ...
          Development, doing business as Bravo Echo Web Development (“Bravo Echo
          Web Development”, “we”, “us”, or “our”). We are committed to
        ...
        include the following: Publicly Available Personal Information. We
        collect first name, maiden name, last name, and nickname; phone numbers;
        email addresses; business email; business phone number; social media;
        and other similar data. Personal Information Provided by You. We collect
        data collected from surveys; financial information (credit card number,
        purchase history, invoices); passwords; and other similar data. All
        personal information that you provide to us must be true, complete and
        accurate, and you must notify us of any changes to such personal
        information. 2. HOW DO WE USE YOUR INFORMATION? In Short: We process
        your information for purposes based on legitimate business interests,
        the fulfillment of our contract with you, compliance with our legal
        obligations, and/or your consent. We use personal information collected
        via our Services for a variety of business purposes described below. We
        ...
        choose to link your account with us to a third party account (such as
        your Google or Facebook account), we use the information you allowed us
        to collect from those third parties to facilitate account creation and
        logon process for the performance of the contract. To send you marketing
        ...
        the "WHAT ARE YOUR PRIVACY RIGHTS" below). To send administrative
        ...
        changes to our terms, conditions, and policies. To post testimonials. We
        ...
        name and testimonial. If you wish to update, or delete your testimonial,
        please contact us at brian@bravoechoweb.com and be sure to include your
        name, testimonial location, and contact information. To manage user
        accounts. We may use your information for the purposes of managing our
        account and keeping it in working order. To respond to user
        ...
        use of our Services. For other Business Purposes. We may use your
        ...
        your consent. 3. WILL YOUR INFORMATION BE SHARED WITH ANYONE? In Short:
        ...
        given us specific consent to use your personal information in a specific
        ...
        our contract. Legal Obligations: We may disclose your information where
        ...
        are involved. More specifically, we may need to process your data or
        share your personal information in the following situations: Vendors,
        ...
        technology on the Services, which will enable them to collect data about
        how you interact with the Services over time. This information may be
        ...
        purposes. Business Transfers. We may share or transfer your information
        ...
        Services. These companies may use information about your visits to our
        ...
        goods and services of interest to you. 4. HOW LONG DO WE KEEP YOUR
        INFORMATION? In Short: We keep your information for as long as necessary
        to fulfill the purposes outlined in this privacy policy unless otherwise
        required by law. We will only keep your personal information for as long
        as it is necessary for the purposes set out in this privacy policy,
        ...
        policy will require us keeping your personal information for longer than
        the period of time in which users have an account with us. When we have
        ...
        possible. 5. DO WE COLLECT INFORMATION FROM MINORS? In Short: We do not
        ...
        brian@bravoechoweb.com. 6. WHAT ARE YOUR PRIVACY RIGHTS? In Short: You
        ...
        email us at brian@bravoechoweb.com. Account Information If you would at
        any time like to review or change the information in your account or
        terminate your account, you can: ■ Log into your account settings and
        update your user account. Upon your request to terminate your account,
        we will deactivate or delete your account and information from our
        active databases. However, some information may be retained in our files
        to prevent fraud, troubleshoot problems, assist with any investigations,
        enforce our Terms of Use and/or comply with legal requirements. Opting
        out of email marketing: You can unsubscribe from our marketing email
        list at any time by clicking on the unsubscribe link in the emails that
        we send or by contacting us using the details provided below. You will
        then be removed from the marketing email list – however, we will still
        ...
        Access your account settings and update preferences. ■ Contact us using
        the contact information provided. 7. CONTROLS FOR DO-NOT-TRACK FEATURES
        ...
        practice in a revised version of this privacy policy. 8. DO CALIFORNIA
        RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS? In Short: Yes, if you are a
        resident of California, you are granted specific rights regarding access
        to your personal information. California Civil Code Section 1798.83,
        ...
        a registered account with the Services, you have the right to request
        ...
        from our systems. 9. DO WE MAKE UPDATES TO THIS POLICY? In Short: Yes,
        ...
        frequently to be informed of how we are protecting your information. 10.
        HOW CAN YOU CONTACT US ABOUT THIS POLICY? If you have questions or
        comments about this policy, you may email us at brian@bravoechoweb.com
        or by post to: Bravo Echo Web Development 3760 Sixes Rd Ste 126-239
        Canton, GA 30114 United States HOW CAN YOU REVIEW, UPDATE, OR DELETE THE
        DATA WE COLLECT FROM YOU? Based on the laws of some countries, you may
        have the right to request access to the personal information we collect
        from you, change that information, or delete it in some circumstances.
        To request to review, update, or delete your personal information,
        please submit a request form by clicking here. We will respond to your
